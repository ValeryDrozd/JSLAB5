...
//GENERATE LIST WITH ORDER
export async function generateOrder(id){
    //GETTING DATA OF THE ORDER
    let order =  getOrder();
    ...
    let form = '<div id="list"><h3 style="text-align:center;">Order id:'+id+'</h3><table>';
        ...
        form+='</tr>';
    let sum = 0;
    //GENERATING CONTENT OF THE TABLE AND COUNTING SUM
    ...
    //GETTING DELIVERY DATE AND TIME AND INSERTION IT IN THE DATA FIELD
